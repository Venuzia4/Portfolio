    ...
    <div className="bg-primary text-center">
      ...
      <div className="bg-primary">
        ...
        <div className="md:flex mb-10 md:p-4 md:m-10  p-10 rounded-full ">
          ...
          <img
            className="mx-auto w-50 h-50 mb-20  rounded-full  "
            src={identity}
            alt={code}
          />
      ...
      <div>
        <h2 className="text-4xl mt-10 text-center  bg-purple-100 rounded-full m-8 ">Skills</h2>
        ...
        <div>
          <h2 className="text-3xl mt-10 mt-10 text-center  bg-purple-100 rounded-full m-8">My projects</h2>
...
<div className="mx-auto md:grid md:grid-cols-3 md:items-center md:p-10 md:m-10">
  <div className="max-w-sm  rounded  shadow-lg">
  <img className="w-full mx-auto m-4 p-5 rounded" loading="lazy" src={yali} alt="yali"/>
  <a className="px-6 py-2 rounded-full bg-black text-white" href="https://yalinov.bordeaux-1.wilders.dev/" target="_blank" rel="noopener noreferrer">View website</a>
  <div className="px-6 py-4">
    <p className="text-gray-700 text-base">Projet fullstack react/ nodeJs /tailwind 
    </p>
  </div>
  </div>
  <div className="max-w-sm rounded overflow-hidden shadow-lg">
  <img className="w-full mx-auto m-4 p-5 rounded" src={replik} alt="replik"/>
  <a className="px-6 py-2 rounded-full bg-black text-white" href="https://noplr.bordeaux-1.wilders.dev" target="_blank" rel="noopener noreferrer">View website</a>
  <div className="px-6 py-4">
  ...
  <div className="max-w-sm rounded overflow-hidden shadow-lg">
  <img className="w-full mx-auto  m-4 p-5 rounded" src={wild} alt="wild"/>
  <a className="px-6 py-2 rounded-full bg-black text-white" href="https://matthieuelie.github.io/wild-cat/" target="_blank" rel="noopener noreferrer">View website</a>
