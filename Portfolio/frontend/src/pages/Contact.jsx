...
export default function Contact() {
  ...
  function linkClick() {
    window.location.assign(
      "https://www.linkedin.com/in/venuzia-babongui-mabika/"
    );
  }
  ...
  return (
    <div className="py-2 ">
      <h2 className=" mt-10 text-3xl mt-10 text-center  bg-purple-100 rounded-full m-8">
        Contact
      </h2>

      <img
        className="mx-auto w-40 h-30 md:w-[30%]"
        src={contact}
        alt={contact}
      />
          ...
          <form method="POST" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-5">
              <textarea
                ...
                placeholder="Enter you mesage here"
      ...
      <p className=" text-center">
        2022 - venuzia Babongui Mabika &#169; - Web developper.
      </p>

      {sentMessage && <Modal onClose={handleOnClose} visible={shoMyModal} />}
    </div>
  );
}
